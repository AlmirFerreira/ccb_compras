...
<tr>
 ...
 <input type="button" class="botao" onclick="javascript: window.location.href='sis_view_tipos.jsp'" value="Lista Tipos de Produto" />&nbsp;</td>
</tr>
<tr>
 <td height="25"></td>
</tr>
<tr>
 ...
 <%} %>
  ...
  <tr>
    ...
    <input type="hidden" name="fornecedorID" value="0" />
    </td>
  </tr>
  <tr>
  ...
  <tr>
    <td align="left">&nbsp;</td>
    <td align="left"><input name="precoCusto" type="hidden" value="<%=rs02.getString("precoCusto") %>" size="20" maxlength="10" onkeypress="venda(); verPonto(); return numeroVirgula(this);"  onblur="verPonto(); venda()"/></td>
    <td align="left">&nbsp;</td>
    <td align="left"><input name="precoVenda" type="hidden" value="<%=rs02.getString("preco") %>" size="20" maxlength="10" onkeypress="verMargem(); verPonto(); return numeroVirgula(this);" onblur="verPonto(); verMargem()" /></td>
    <td align="center"></td>
    <td align="left"><input name="lucro" style="border:2px dashed #00CC33; padding-left:4px; height:18px;" onblur="verPorcentagem()" onkeypress="verPorcentagem(); verPonto();" type="hidden" size="5" maxlength="3" value="<%=rs02.getString("lucro") %>" /></td>
  </tr>
  <tr>
    <td align="left">&nbsp;</td>
    <td align="left"><input type="hidden" name="estoqueMinimo" size="20" maxlength="5" value="<%=rs02.getString("estoqueMinimo") %>" onKeyPress="return numero(this)"/> 
    <input type="hidden" name="estoque" value="<%=rs02.getString("estoque") %>" /></td>
    <td align="left"></td>
