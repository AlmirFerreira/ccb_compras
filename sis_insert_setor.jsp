...
<tr>
 ...
 <input type="button" class="botao" onclick="javascript: window.location.href='sis_view_setores.jsp'" value="Lista Setores" />&nbsp;&nbsp;</td>
</tr>
<tr>
 <td height="25"></td>
</tr>
...
<table align="center" style="width:450px; height:200px; border:1px solid #333">
 ...
 <form name="form1" method="post" action="sis_insert_manager_setor.jsp" onsubmit="return verForm(this)">
 ...
 <%} %>
  <tr>
   <td colspan="2" align="center"><strong>CADASTRO DE SETOR</strong></td>
  </tr>
  <tr>
    <td width="127" align="left">Nome do Setor:</td>
