...
<tr>
 ...
 <%} %>
  ...
  <tr>
    ...
    <input type="hidden" name="fornecedorID" value="0" />    </td>
  </tr>
  <tr>
  ...
  <tr>
    <td align="left">&nbsp;</td>
    <td align="left"><input name="precoCusto" type="hidden" value="1.00" size="20" maxlength="10" onkeypress="venda(); verPonto(); return numeroVirgula(this);"  onblur="verPonto(); venda()"/></td>
    <td align="left">&nbsp;</td>
    <td align="left"><input name="precoVenda" type="hidden" value="1.00" size="20" maxlength="10" onkeypress="verMargem(); verPonto(); return numeroVirgula(this);" onblur="verPonto(); verMargem()" /></td>
    <td align="center"></td>
    <td align="left"><input name="lucro" type="hidden" style="border:2px dashed #00CC33; padding-left:4px; height:18px;" onblur="verPorcentagem()" onkeypress="verPorcentagem(); verPonto();" value="0.0" size="5" maxlength="3" /></td>
  </tr>
  <tr>
    <td align="left">&nbsp;</td>
    <td align="left"><input type="hidden" name="estoqueMinimo" size="20" maxlength="5" onKeyPress="return numero(this)" value="0"/></td>
    <td align="left"></td>
