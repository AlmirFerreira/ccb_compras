...
rs = st.executeQuery(igreja.listaIgrejas());
%>
...
<tr>
 ...
 <br />
  <table width="470" align="center" cellpadding="0" cellspacing="0">
   <tr>
    <td colspan="4" align="center"><strong>LISTA DE IGREJAS</strong></td>
   </tr>
   <tr>
     <td colspan="4" height="15"></td>
   </tr>
   <tr bgcolor="#EEEEEE">
    <td width="250" align="left"><strong>Igreja&nbsp;&nbsp;&nbsp;/&nbsp;&nbsp;&nbsp;Setor</strong></td>
...
%>
   ...
   <tr>
    <td height="30" width="250" align="left"><%=rs.getString("nome")%>&nbsp;&nbsp;&nbsp;/&nbsp;&nbsp;&nbsp;<%=rs.getString("setorNome")%></td>
    <td height="30" width="60" align="center"><a href="sis_update_igreja.jsp?igrejaID=<%=rs.getString("igrejaID")%>"><img src="ico/ico_editar.png" width="20" height="20" border="0" title="Editar <%=rs.getString("nome")%>" /></a></td>
    <%
	//Verifica o status se está ativo ou não
	String status = rs.getString("status");
	if(status.equals("S")){
	%>
    <td height="30" width="60" align="center"><a href="sis_view_igrejas.jsp?acao=1&igrejaID=<%=rs.getString("igrejaID")%>"><img src="ico/ico_ativo.png" width="20" height="20" border="0" title="Desativar <%=rs.getString("nome")%>" /></a></td>
    <%}else if(status.equals("N")){%>
    <td height="30" width="60" align="center"><a href="sis_view_igrejas.jsp?acao=2&igrejaID=<%=rs.getString("igrejaID")%>"><img src="ico/ico_inativo.png" width="20" height="20" border="0" title="Ativar <%=rs.getString("nome")%>" /></a></td>
    <%}%>
    
    <td height="30" width="60" align="center"><a href="javascript:excluir(<%=rs.getString("igrejaID")%>)"><img src="ico/ico_excluir.png" width="20" height="20" border="0" title="Excluir <%=rs.getString("nome")%>" /></a></td>
   </tr>
   <tr>
