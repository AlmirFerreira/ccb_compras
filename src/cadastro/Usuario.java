...
public class Usuario {
	...
	public String usuarioPorID(){
		return "SELECT * FROM usuario WHERE usuarioID = '"+usuarioID+"'";
	}
	...
	public String salvaUsuario(){
		...
		inserirNaBase += "(usuarioNome, usuarioTelefone, usuarioEmail, usuarioLogin, usuarioSenha, usuarioNivel) ";
		inserirNaBase += "VALUES ('"+nome+"', '', '"+email+"', '"+login+"', '"+senha+"', '"+nivel+"')";
	...
	public String editarUsuario(){
		...
		atualizaUsuario += "SET usuarioNome = '"+nome+"', usuarioEmail = '"+email+"', usuarioLogin = '"+login+"', usuarioSenha = '"+senha+"', usuarioNivel = '"+nivel+"' ";
