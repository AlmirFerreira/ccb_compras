...
//Bloqueia a Visualização dos pedidos pendentes
if(urlCaminho.equals("sis_view_pedidos_pendentes.jsp") && nivelUsuario.equals("2")){
	response.sendRedirect("sis_menu.jsp?msg=2");
}

//Bloqueia a Visualização da Trasferência de Coletas
if(urlCaminho.equals("sis_transferencia_coleta.jsp") && nivelUsuario.equals("2")){
	response.sendRedirect("sis_menu.jsp?msg=2");
}
...
//Bloqueia a Visualização dos pedidos pendentes
if(urlCaminho.equals("sis_view_pedidos_pendentes.jsp") && nivelUsuario.equals("3")){
	response.sendRedirect("sis_menu.jsp?msg=2");
}

//Bloqueia a Visualização da Trasferência de Coletas
if(urlCaminho.equals("sis_transferencia_coleta.jsp") && nivelUsuario.equals("3")){
	response.sendRedirect("sis_menu.jsp?msg=2");
}
...
//Bloqueia a Visualização dos pedidos pendentes
if(urlCaminho.equals("sis_view_pedidos_pendentes.jsp") && nivelUsuario.equals("4")){
	response.sendRedirect("sis_menu.jsp?msg=2");
}

//Bloqueia a Visualização da Trasferência de Coletas
if(urlCaminho.equals("sis_transferencia_coleta.jsp") && nivelUsuario.equals("4")){
	response.sendRedirect("sis_menu.jsp?msg=2");
}
...
//Bloqueia a Visualização dos pedidos pendentes
if(urlCaminho.equals("sis_view_pedidos_pendentes.jsp") && nivelUsuario.equals("5")){
	response.sendRedirect("sis_menu.jsp?msg=2");
}

//Bloqueia a Visualização da Trasferência de Coletas
if(urlCaminho.equals("sis_transferencia_coleta.jsp") && nivelUsuario.equals("5")){
	response.sendRedirect("sis_menu.jsp?msg=2");
}
...
//Bloqueia a Visualização dos pedidos pendentes
if(urlCaminho.equals("sis_view_pedidos_pendentes.jsp") && nivelUsuario.equals("6")){
	response.sendRedirect("sis_menu.jsp?msg=2");
}

//Bloqueia a Visualização da Trasferência de Coletas
if(urlCaminho.equals("sis_transferencia_coleta.jsp") && nivelUsuario.equals("6")){
	response.sendRedirect("sis_menu.jsp?msg=2");
}
