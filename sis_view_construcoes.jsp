...
<script type="text/javascript">
 function excluir(construcaoID){
	if(confirm("Tem certeza que deseja Excluir essa Construção?")){
...
%>
   ...
   <tr>
    ...
    <td height="30" width="60" align="left"><a href="sis_update_construcao.jsp?construcaoID=<%=rs.getString("construcaoID")%>"><img src="ico/ico_editar.png" width="20" height="20" title="Editar Serviço" border="0" /></a></td>
    <%
