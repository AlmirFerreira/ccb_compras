...
<%
//Atribui o ID da construçao a construcaoID
construcao.construcaoID = Integer.parseInt(request.getParameter("construcaoID"));
%>

<%
//Pesquisa os dados da Construçao/Serviço a ser alterado
rs01 = st01.executeQuery(construcao.construcaoPorID());
%>


<%
//Verifica se trouxe algum resultado a constulta e preenche as variáveis
int igrejaID			= 0;
String igrejaNome 		= "";
